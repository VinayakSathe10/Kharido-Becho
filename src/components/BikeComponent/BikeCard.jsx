...
export default function BikeCard({ bike }) {
  ...
  bike.images?.[0]?.image_link || // optional fallback
  bike.image ||
  "https://via.placeholder.com/350x230?text=No+Image";


  const handleViewDetails = () => {
    // assuming your route is /buy/bikes/:id and id is bike_id
    navigate(`/buy/bikes/${bike.bike_id}`);
  };

  return (
    <div className="bg-white rounded-xl shadow hover:shadow-xl transition p-3 cursor-pointer">
      {/* Image */}
